  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('admin') ?>" class="brand-link">
      <img src="<?= base_url('assets/') ?>dist/img/LOGO APT.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">APOTEK CILIK NELIN</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url('assets/') ?>dist/img/LOGO APT.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
